...
def run_backtest_strict(min_trade_val=2000.0, deadband=0.04):
    # 1. 加载资产清单
...
if __name__ == "__main__":
    val, trades, fees = run_backtest_strict(2000.0, 0.04)
    print(f"--- 🚀 SkyNet '200元目标版' 回测 (2000元门槛 / 4%死区) ---")
