...
def run_backtest_precise(min_trade_val=1500.0, deadband=0.03):
    # 1. 加载资产清单
...
if __name__ == "__main__":
    val, trades, fees = run_backtest_precise(1500.0, 0.03)
    print(f"--- 🚀 SkyNet '200元目标版' 回测 (1500元门槛 / 3%死区) ---")
